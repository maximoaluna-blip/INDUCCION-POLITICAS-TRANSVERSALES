...
| **Quizzes de escenario, no de memoria** | **11 de 14 plantean una situación** y piden decidir. Las tres restantes —**L3-P2, L4-P1 y L6-P2**— son de comprensión directa y están ancladas a cita literal. *(Recontado tras aplicar las diez reescrituras de la auditoría pedagógica. **Criterio explícito**, para que el próximo recuento no vuelva a inflarse: cuenta como escenario la pregunta cuyo enunciado describe **una situación concreta con personas** y pide decidir qué hacer o qué responder; no cuentan las que empiezan por «según…», «¿cuándo…?» o «¿qué significa…?». El acta declaró primero 12, luego «unas 9», y la auditoría pedagógica contó **5** —7 con criterio generoso— sobre la versión anterior.)* |
