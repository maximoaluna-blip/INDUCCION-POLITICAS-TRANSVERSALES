 ...
 * La URL base apunta a la carpeta de cursos de la linea Politicas Transversales.
 */
const BASE_URL =
  process.env.ASC_BASE_URL ||
  'https://maximoaluna-blip.github.io/INDUCCION-POLITICAS-TRANSVERSALES/02-Plataforma-Web/';
